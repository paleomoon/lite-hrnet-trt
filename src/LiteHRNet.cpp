...
int main()
{
	string engineFile = "litehrnet_30_coco_384x288-dynamic.trt";
	...
	vector<Mat> images;
	Mat srcImg1 = imread("image/1.jpg");
	Mat srcImg2 = imread("image/2.jpg");
	...
	for (int i = 0; i < batchSize; i++)
	{
		...
		string outName = "image/out"+to_string(i) + ".jpg";
